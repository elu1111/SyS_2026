...
Un filtro es un sistema din\'{a}mico con una respuesta en frecuencia especial que nos permite 
procesar la entrada para obtener una salida con un contenido arm\'{o}nico conveniente.

\subsection{\textquestiondown Porqu\'{e} estudiar filtros?}
...
\subsection{\textquestiondown Qu\'{e} tipos de filtros vamos a estudiar?}

\begin{enumerate}
\item   Filtros lineales de tiempo continuo:
  \begin{enumerate}
...
\item   Filtros lineales de tiempo discreto: 
  \begin{enumerate}
...
\subsection{\textquestiondown Cu\'{a}l es el uso de los filtros que estudiamos?}

Los filtros que estudiamos se usan para 
...
\subsection{\textquestiondown C\'{o}mo funciona un filtro?}

Los filtros lineales se basan en el concepto de respuesta en frecuencia de un sistema.  
\begin{enumerate}
